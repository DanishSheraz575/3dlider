...
function call_ajax_with_functions_survey(response_div, php_file, form_data, functions) {
    let request =  new XMLHttpRequest();
    request.open("POST", php_file, true);
    request.send(form_data);
    console.log(form_data)
